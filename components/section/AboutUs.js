    ...
    <>
      ...
      >
        <div className="flex justify-center sm:translate-x-[-20px] max-sm:flex-col">
          ...
          <div className="flex-[6] px-8 py-14 w-[600px] max-sm:w-full max-sm:px-10 max-sm:py-6">
          ...
          <div className="py-14 max-sm:flex max-sm:justify-center max-sm:scale-90 max-sm:pt-0 max-sm:pb-5">
      ...
      >
        <div className="relative max-sm:flex">
          <div className="w-[579px] h-[714px] overflow-hidden max-sm:w-[384px] max-sm:h-[400px] max-sm:mr-5 max-sm:ml-2">
            <Image
            ...
            />
            <div className="absolute top-[-5px] left-[-5px] w-[79px] h-[62px] max-sm:left-[5px] max-sm:top-[-12px]">
              <svg
            ...
            <div className="absolute bottom-[-7px] right-[-7px] w-[79px] h-[62px] rotate-180 max-sm:right-[7px] max-sm:bottom-[-11px]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="100%"
                height="100%"
        ...
        <div className="w-[750px] justify-center flex flex-col gap-28 relative z-10 max-sm:w-full max-sm:pt-14">
          <div className="pl-12 w-[630px] flex flex-col gap-5 max-sm:w-fit max-sm:justify-center max-sm:pl-0 max-sm:mx-10">
            <div className="text-[#ADFFFD] text-[38px] font-bold leading-[1.2] flex items-center gap-12 max-sm:text-[30px]">
              <div className="z-20">{t("common:about:vision:title")}</div>
              <div className="w-[111px] h-[8px] bg-[#FFDE59]"></div>
            </div>
            <div className="text-white text-[28px] leading-[1.4] text-justify max-sm:text-[18px]">
          ...
          >
            <div className="flex flex-col gap-3 max-sm:mx-10">
              <div className="text-[#ADFFFD] text-right text-[35px] font-bold leading-[1.2] flex justify-end items-end gap-5 max-sm:flex-row-reverse max-sm:items-start">
                <div className="w-[111px] h-[8px] bg-[#FFDE59] mb-2 max-sm:mt-3"></div>
